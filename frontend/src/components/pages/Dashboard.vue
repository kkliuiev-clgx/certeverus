        ...
        <v-container>
          <v-container class="grey- lighten-5">
            ...
            <v-row name = "bottom-row">
              ...
              <v-col
                v-if="currentChart == 'single_factor' || currentChart == 'waterfall'||currentChart =='isoquant'||currentChart =='prescriptions'"
              ...
              >
                ...
                <v-switch
                  color="grey"
                  v-if="currentChart == 'waterfall'|| currentChart == 'prescriptions'"
  ...
  computed: {
    ...
    showDateOptions() {
      return (
        ...
        this.currentChart === "isoquant" ||
        this.currentChart === "waterfall" ||
        this.currentChart === "prescriptions"
      );
    },
    currentParent() {
        ...
        .then((response) => {
          if (response.data.success) {
            ...
            switch(this.model.client_name){
                ...
                case 'Accordion_source':
                    this.model.parent = "Sourcing";
                    this.model.start_date = "2021-01-01";
                    this.model.end_date ="2021-06-30";
                    break;

                case 'Alloy_Plan':
                    this.model.parent = "Portfolio";
                    this.model.start_date = "2020-09-01";
                    this.model.end_date ="2021-12-31";
                    break;
                    
                case 'Alloy_Pilot':
                    this.model.parent = "Portfolio";
                    this.model.start_date = "2021-09-01";
                    this.model.end_date ="2023-12-31";
                    break;
                    
                case 'Alloy_Scale':
                    this.model.parent = "Portfolio";
                    this.model.start_date = "2021-09-01";
                    this.model.end_date ="2024-08-31";
                    break;
                    
                case 'SalesDemo2':
                    this.model.parent = "Revenue";
                    this.model.start_date = "2020-01-01";
                    this.model.end_date ="2020-09-30";
                    break;

                case 'Channel_Mgr':
                    this.model.parent = "Revenue";
                    this.model.start_date = "2020-01-01";
                    this.model.end_date ="2020-08-31";
                    break;
                
                case 'legal_demo':
                    this.model.parent = "Net Revenue";
                    this.model.start_date = "2021-01-01";
                    this.model.end_date ="2021-12-31";
                    break;
            ...
            console.log("PARENT is ", this.model.parent);
            // this.model.end_date = "2023-12-31";
